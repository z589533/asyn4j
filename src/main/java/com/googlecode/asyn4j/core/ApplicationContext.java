...
public class ApplicationContext implements Serializable{
 ...
 // call back block queue
    ...
    public ApplicationContext(int maxCacheWork, long addWorkWaitTime, int workThreadNum, int callBackThreadNum,
        ...
        ApplicationContext.maxCacheWork = maxCacheWork;
        ApplicationContext.addWorkWaitTime = addWorkWaitTime;
        ApplicationContext.work_thread_num = workThreadNum;
        ApplicationContext.callback_thread_num = callBackThreadNum;
        ApplicationContext.closeServiceWaitTime = closeServiceWaitTime;
